...
BT::NodeStatus SetStatus::onStart()
{
  ...
  switch (kStatuses.at(status_name)) {
    case TreeStatus::Undefined:
      cmd.red = 255; cmd.green = 255; cmd.blue = 255; cmd.mode = cmd.MODE_SOLID;
      cmd.target = cmd.TARGET_ALL; break;
    case TreeStatus::Waiting:
      cmd.red = 255; cmd.green = 0; cmd.blue = 0; cmd.mode = cmd.MODE_SOLID;
      cmd.target = cmd.TARGET_ALL; break;
    case TreeStatus::Starting:
      cmd.red = 0; cmd.green = 0; cmd.blue = 255; cmd.mode = cmd.MODE_SLOW_FLASH;
      cmd.target = cmd.TARGET_ALL; break;
    case TreeStatus::Moving:
      cmd.red = 0; cmd.green = 255; cmd.blue = 0; cmd.mode = cmd.MODE_SOLID;
      cmd.target = cmd.TARGET_ALL; break;
    case TreeStatus::Searching:
      cmd.red = 255; cmd.green = 100; cmd.blue = 0; cmd.mode = cmd.MODE_SOLID;
      cmd.target = cmd.TARGET_ALL; break;
    case TreeStatus::Aligning:
      cmd.red = 255; cmd.green = 0; cmd.blue = 255; cmd.mode = cmd.MODE_SLOW_FLASH;
      cmd.target = cmd.TARGET_ALL; break;
    case TreeStatus::Performing:
      cmd.red = 0; cmd.green = 0; cmd.blue = 255; cmd.mode = cmd.MODE_FAST_FLASH;
      cmd.target = cmd.TARGET_ALL; break;
    case TreeStatus::Success:
      cmd.red = 0; cmd.green = 255; cmd.blue = 0; cmd.mode = cmd.MODE_BREATH;
      cmd.target = cmd.TARGET_ALL; break;
    case TreeStatus::Failure:
      cmd.red = 255; cmd.green = 0; cmd.blue = 0; cmd.mode = cmd.MODE_BREATH;
      cmd.target = cmd.TARGET_ALL; break;
    case TreeStatus::Panic:
      cmd.red = 255; cmd.green = 0; cmd.blue = 0; cmd.mode = cmd.MODE_FAST_FLASH;
      cmd.target = cmd.TARGET_ALL; break;
  }
...
BT::NodeStatus SetStatus::onRunning()
{
  return BT::NodeStatus::SUCCESS;
}
